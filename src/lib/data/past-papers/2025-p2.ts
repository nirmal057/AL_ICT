...
<p><b>ලැයිස්තුව:</b> {1 – &lt;?php, 2 – product_id, 3 – $row['id'], 4 – row['price'], 5 – "SELECT * FROM Book", 6 – "SELECT * FROM Books_database", 7 – shop.css, 8 – shop.php}</p>`,
  ...
  },
  {
    id: "pq-2025-p2-4",
    questionNumber: "4",
    content: `<p>4. පරිගණකය සකසනයේ P<sub>0</sub>, P<sub>1</sub> ක්‍රියාවන සහ මෙහෙයුම් පද්ධතියට (OS) අදාළව පහත ක්‍රියාකාරීම් අනුක්‍රමය සිදු වේ: OS &rarr; P<sub>0</sub> &rarr; OS &rarr; P<sub>1</sub> &rarr; OS &rarr; P<sub>0</sub> &rarr; OS &rarr; P<sub>1</sub> ...</p>`,
    totalMarks: 10,
    ...
    subParts: [
      ...
      },
      {
        id: "pq-2025-p2-4-b",
        label: "(b)",
        content: `<p>පරිගණකයක මතක කළමනාකරණය හා අතථ්‍ය මතකය (Virtual Memory) සම්බන්ධ පහත ප්‍රශ්නවලට පිළිතුරු සපයන්න.</p>`,
        marks: 3,
        subParts: [
          {
            id: "pq-2025-p2-4-b-i",
          ...
          <div style="display: flex; gap: 20px; justify-content: center; margin: 15px 0; text-align: center; flex-wrap: wrap;">
            <table border="1" style="border-collapse: collapse; padding: 5px; text-align: center;">
              <thead>
      ...
      },
      {
        id: "pq-2025-p2-4-c",
        label: "(c)",
        content: `<p>ගොනු පද්ධති (File Systems) සහ ගොනු විභාජන වගුව (FAT) සම්බන්ධ පහත ප්‍රශ්නවලට පිළිතුරු සපයන්න.</p>`,
        marks: 3,
        subParts: [
          {
            id: "pq-2025-p2-4-c-i",
          ...
          <div style="overflow-x: auto; margin: 15px 0;">
            <table border="1" style="border-collapse: collapse; margin: 0 auto; text-align: center;">
              <tbody>
                <tr>
                  <th style="padding: 5px; background-color: #f2f2f2;">FAT</th>
